...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { city: @practice.city, name: @practice.name } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { city: @practice.city, name: @practice.name } }
